...
# Basic settings
# ------------------------------------------------------------------------------ #
_C.ROOT = 'D:/WorkSpace/RGBDFusion'  # Root directory of this project (.../spnv2)
...
_C.DATASET.ROOT = 'D:/WorkSpace/SpaceAwarness/Dataset'  # Root directory of all datasets
_C.DATASET.DATANAME = 'RAPTOR'  # Dataset name
_C.DATASET.DOMAIN = 'D1'        # Dataset Domain
_C.DATASET.CAMERA = 'config/camera.json'  # .json file containing camera parameters
_C.DATASET.KEYPOINTS = 'config/keypoints.csv'  # .mat file containing [3 x N] keypoints (m)

# - Dataset characteristics
_C.DATASET.NUM_KEYPOINTS = 26  # Number of keypoints to detect
_C.DATASET.NUM_ANCHORS = 9  # Number of anchors for bounding box
_C.DATASET.MAX_NUM_OBJECTS = 1  # Duh

# - I/O
_C.DATASET.IMAGE_SIZE = [2048, 2048]  # Original image size [W, H]
...
def update_config(cfg, args):
    ...
    cfg.DATASET.KEYPOINTS = join(cfg.DATASET.ROOT, cfg.DATASET.DATANAME, cfg.DATASET.KEYPOINTS)
